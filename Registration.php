...
<?php
    ...
    $religionErr="Please select a religion";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      //religion validation//religion religion validation//religion validation
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >
  ...
  <fieldset>
    ...
    <input type="text" name="name2" id="lastName" onkeyup="lastNameVal()"><br><br>
    <span class="error" id="lastNameErr">* <?php echo $nameErr2;?></span>
  </fieldset><br><br>
  ...
  <fieldset>
    <legend  > <b> DATE OF BIRTH:</legend><br>
  	<input type="date" min="1953-01-01" max="1998-12-31" id="birthdate" name="birthdate" id="dob" ><br><br>
    <span class="error" id="dobErr" >* <?php echo $birthdateErr;?></span><br><br>
  </fieldset><br><br>


  <fieldset>
    <legend  > <b> Religion :</legend><br>
    <select id="Religion" name="religion" onchange="religionVal()">
    ...
    <br><br>
    <span class="error" id="religionErr">*<?php echo $religionErr;?></span><br><br> 
  </fieldset><br><br>
  ...
  <fieldset>
    ...
    <span class="error" id="userErr">* <?php echo $usernameErr;?></span><br><br> 
  </fieldset><br><br>
  ...
  <fieldset>
    ...
    <span class="error" id="passErr">* <?php echo $newpassErr;?></span><br><br>
  </fieldset><br><br>


  <fieldset>
    <legend  > <b>Confirm Password :</legend><br>
    <input type="Password" name="renewpass" id="rePassword" onkeyup="RePassVal()"><br><br>
