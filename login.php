...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
  <fieldset>
	...
	<span id="userErr" class="error">* <?php echo $usernameErr;?></span><br><br>
	Password : &nbsp; 

	<input id="password" type="text" name="password"  onkeyup="passVal()"> <br><br>
	<span id="passErr" class="error"> * <?php echo $passwordErr;?></span><br><br>
